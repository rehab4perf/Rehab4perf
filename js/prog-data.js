...
/* La table des sports vit dans js/volume-sport.js : l'espace athlète la lit aussi. */
...
/* Les périodes calendaires (_pevoJour … _pevoPeriode) vivent dans js/volume-sport.js :
   l'espace athlète s'en sert pour son propre sélecteur. */
...
function _renderPevoCharts(exoData, selectedKeys) {
  ...
  try {
    ...
    if(_pevoPer){
      ...
      volSectionHtml = _volHtml(_volumeParSport(_volNbSemaines(_pevoPer, _pevoAujourdhuiIso())), _pevoPer);
    } else {
...
/* Le rendu du volume d'entraînement (_volHtml) vit dans js/volume-sport.js. */
