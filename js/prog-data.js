...
function buildExportHTML(){
  ...
  return '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Prescription – '+escH(patient)+'</title><style>'
    ...
    +'.logo{display:inline-flex;align-items:baseline;line-height:1;white-space:nowrap;margin-bottom:8px}'
    ...
    +'.logo .e{font-family:\'Cormorant Garamond\',serif;font-style:italic;font-weight:600;font-size:.44em;vertical-align:super;color:#fff;margin:0 .05em 0 .01em;line-height:0}'
    ...
    +'<div class="header">'
    +'<div class="logo"><span class="r">rehab<sup class="e">4</sup></span><span class="p">perf</span></div>'
