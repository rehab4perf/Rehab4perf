...
function buildExportHTML(){
  ...
  return '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Prescription – '+escH(patient)+'</title><style>'
    ...
    +'.logo{display:flex;align-items:center;gap:7px;font-family:\'Comfortaa\',sans-serif;font-size:.72rem;font-weight:700;letter-spacing:.1em;margin-bottom:8px;color:#fff}'
    +'.logo svg{display:block;flex-shrink:0}'
    +'.logo .r{color:#fff}.logo .n{color:#7FA8D9;font-weight:800}.logo .p{color:#fff}'
    ...
    +'</style><link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@700&display=swap" rel="stylesheet"></head><body>'
    +'<div class="header">'
