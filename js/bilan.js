...
function _buildEvolutionHTML(){
  ...
  var css = ':root{--green:#2D6A4F;--green-l:#E8F5EE;--red:#C0392B;--red-l:#FDECEA;--border:#E8E6E1;--text:#1A1917;--text2:#6B6860;--text3:#9D9B96;--accent2:#1A3A5C;--surface2:#F1F0ED;--surface:#FFFFFF;--accent:#2B5FA6;--accent-l:#EEF3FB}'
    ...
    + '.doc-logo{display:flex;align-items:center;gap:8px;font-family:\'Comfortaa\',sans-serif;font-size:.8rem;font-weight:700;letter-spacing:.1em;color:#fff}'
    + '.doc-logo svg{display:block;flex-shrink:0}'
    + '.doc-logo .r{color:#fff}.doc-logo .n{color:#7FA8D9;font-weight:800}.doc-logo .p{color:#fff}'
  ...
  var html = '<!DOCTYPE html><html lang="fr"><head>'
    ...
    + '<link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@700&display=swap" rel="stylesheet">'
    + '<title>Suivi Évolution — '+(patient||'Patient')+'</title>'
    + '<style>'+css+'</style></head><body><div class="page-wrap">'
    // Header
    + '<div class="doc-header"><div class="doc-logo"><svg viewBox="8 34 164 104" width="26" height="16" aria-hidden="true"><g stroke="#4A90D9" stroke-width="17" stroke-linecap="round" fill="none"><line x1="20" y1="118" x2="56" y2="104"/><line x1="70" y1="122" x2="100" y2="84"/><line x1="112" y1="125" x2="134" y2="66"/><line x1="158" y1="128" x2="158" y2="46"/></g></svg><span><span class="r">rehab</span><span class="n">4</span><span class="p">perf</span></span></div>'
...
function _buildBilanHTML(type) {
  ...
  return {
    html: '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@700&display=swap" rel="stylesheet"><title>'+title+(patient?' — '+patient:'')+'</title><style>'+css+'</style></head><body><div class="page-wrap">'
      + '<div class="doc-header"><div class="doc-logo"><svg viewBox="8 34 164 104" width="26" height="16" aria-hidden="true"><g stroke="#4A90D9" stroke-width="17" stroke-linecap="round" fill="none"><line x1="20" y1="118" x2="56" y2="104"/><line x1="70" y1="122" x2="100" y2="84"/><line x1="112" y1="125" x2="134" y2="66"/><line x1="158" y1="128" x2="158" y2="46"/></g></svg><span><span class="r">rehab</span><span class="n">4</span><span class="p">perf</span></span></div><div class="doc-meta">'+metaParts.join('<br>')+'</div></div>'
