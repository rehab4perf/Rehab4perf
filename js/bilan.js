...
function _crMarquage(fieldIds) {
  ...
  if (et === 'initial') {
    ...
    return { cls: ' cr-item--reev',
             badge: '<span class="cr-mention init">1<sup>re</sup>&nbsp;évaluation'
                  + (di ? ' &mdash; ' + di : '') + '</span>' };
  }
...
function _crLegendeMarquage() {
  ...
  return '<div class="cr-legende">Bilan de suivi. Chaque résultat porte la date de sa '
       + 'dernière réalisation&nbsp;: <em>1<sup>re</sup>&nbsp;évaluation</em> pour une mesure initiale, '
       + '<em>réévalué le&nbsp;…</em> pour un test refait ce jour, '
