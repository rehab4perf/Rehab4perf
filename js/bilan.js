...
function _buildEvolutionHTML(){
  ...
  var css = ':root{--green:#2D6A4F;--green-l:#E8F5EE;--red:#C0392B;--red-l:#FDECEA;--border:#E8E6E1;--text:#1A1917;--text2:#6B6860;--text3:#9D9B96;--accent2:#1A3A5C;--surface2:#F1F0ED;--surface:#FFFFFF;--accent:#2B5FA6;--accent-l:#EEF3FB}'
    ...
    + '.doc-logo{display:flex;align-items:center;gap:8px;font-size:.8rem;font-weight:700;letter-spacing:.14em;color:#fff}'
...
function _buildBilanHTML(type) {
  ...
  return {
    html: '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>'+title+(patient?' — '+patient:'')+'</title><style>'+css+'</style></head><body><div class="page-wrap">'
