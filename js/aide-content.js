...
{ id:'bilan', emoji:'🩺', titre:'Bilan clinique', articles:[
  ...
  { id:'generer-cr', titre:'Générer un compte-rendu',
    ...
    etapes:[
      ...
      { t:'Sur un bilan de suivi, chaque ligne dit quand elle a été mesurée', x:'Quatre mentions possibles. « 1re évaluation — 30/07 » : ce test est mesuré pour la première fois, il n\'y a rien à comparer. « Réévalué le 18/08 » : test déjà connu, refait ce jour, résultat nouveau. « Réévalué le 18/08 — inchangé » : test refait, résultat identique au précédent — c\'est souvent l\'information la plus utile au médecin. Une simple date en gris, avec la valeur en italique : test non recontrôlé, la valeur vient d\'un bilan antérieur. Une légende reprend la convention en tête du CR, pour son destinataire.' },
  ...
  { id:'sauvegarder-bilan', titre:'Sauvegarder, modifier et suivre un bilan',
    ...
    etapes:[
      ...
      { t:'La marque « Réévalué », dans l\'en-tête de chaque bloc', x:'Elle se coche TOUTE SEULE dès que vous touchez un champ du bloc : vous ne changez rien à vos habitudes. Vous ne cliquez dessus que dans un seul cas — test refait, résultat identique, donc rien à modifier. Sans elle, le logiciel ne peut pas distinguer « je n\'ai pas refait ce test » de « je l\'ai refait et rien n\'a bougé », et affichait les deux de la même façon : à la date de l\'ancien bilan.' },
