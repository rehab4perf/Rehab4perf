...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Les modèles d\'exercices',
    ...
    etapes:[
      ...
      { t:'« Ajouter à la séance » : une copie, étapes comprises', x:'Le bouton ⤓, « Ajouter » du panneau Biblio et « + Ajouter à la séance » copient le modèle dans la séance en cours, étapes comprises. Ils ne changent jamais sa nature, même si elle est vide : elle reste la séance du patient, que vous enregistrez ou planifiez. Le modèle, lui, n\'est pas touché.' },
      { t:'Créer un modèle de zéro', x:'Le bouton « Nouveau modèle », en haut du panneau Séances & modèles, ouvre le builder vide, sans patient ni date : vous composez, puis « Enregistrer le modèle ». Si une séance était en cours dans le builder, elle est mise de côté et vous la retrouvez intacte en sortant — rien n\'est effacé.' },
      { t:'Le bandeau dit ce que vous modifiez', x:'Sous l\'en-tête du builder, un bandeau bleu « Séance d\'Antoine · 1 septembre » : vous composez la séance d\'un patient. Un bandeau ambre « Modification du modèle « … » — aucun patient n\'est concerné » : vous modifiez le modèle, et le bouton principal devient « Mettre à jour le modèle ». De là, « Quitter le modèle » en sort sans rien écrire, et « Utiliser pour un patient » copie le modèle dans une séance du patient sélectionné, que vous planifiez ensuite.' },
