...
{ id:'bilan', emoji:'🩺', titre:'Bilan clinique', articles:[
  ...
  { id:'generer-cr', titre:'Générer un compte-rendu',
    ...
    etapes:[
      ...
      { t:'Sur un bilan de suivi, chaque ligne dit quand elle a été mesurée', x:'Trois mentions possibles. « Réévalué le 18/08 » : test refait ce jour, résultat nouveau. « Réévalué le 18/08 — inchangé » : test refait, résultat identique au précédent — c\'est souvent l\'information la plus utile au médecin. Une simple date en gris, avec la valeur en italique : test non recontrôlé, la valeur vient d\'un bilan antérieur. Une légende reprend la convention en tête du CR, pour son destinataire.' },
