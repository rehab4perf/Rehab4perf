...
{ id:'bilan', emoji:'🩺', titre:'Bilan clinique', articles:[
  ...
  { id:'mob-actif-passif', titre:'Amplitudes actif / passif — le raisonnement',
    intro:'Trois menus par mouvement — actif, passif, fin de course — et l\'interprétation s\'écrit toute seule.',
    etapes:[
      ...
      { t:'« Vide » est un signal, pas une raideur', x:'La douleur arrête le mouvement avant toute butée : rupture massive, tumeur ou capsulite. Ce choix prend le pas sur tout le reste de la ligne, quel que soit l\'actif, et le compte-rendu le nomme.' },
      { t:'Où le trouver', x:'Dans les blocs de mobilité de l\'Épaule, du Coude et du Poignet. La colonne « Marqueur / observations » reçoit le secteur qui reproduit la plainte.' },
