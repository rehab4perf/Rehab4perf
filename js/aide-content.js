...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Les modèles d\'exercices',
    ...
    etapes:[
      ...
      { t:'Le bandeau dit ce que vous modifiez', x:'Sous l\'en-tête du builder, une ligne « Antoine Peronnaud · LCA — Phase 1 » : vous composez la séance de ce patient, et le titre dit laquelle (« Séance du 15 septembre »). Un bandeau ambre « Modification du modèle « … » — aucun patient n\'est concerné » : vous modifiez le modèle, et le bouton principal devient « Mettre à jour le modèle ». De là, « Quitter le modèle » en sort sans rien écrire, et « Utiliser pour un patient » copie le modèle dans une séance du patient sélectionné, que vous planifiez ensuite.' },
  ...
  { id:'journal-evolution', titre:'Journal et Évolution',
    ...
    etapes:[
      ...
      { t:'L’export dit la période', x:'L’export HTML ou PDF indique la période et ce que montrent les courbes — toute la rééducation avec la période en bande, ou la période seule.' },
