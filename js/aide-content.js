...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Les modèles d\'exercices',
    ...
    etapes:[
      ...
      { t:'« Ouvrir dans le builder »', x:'Dans la carte dépliée, ce bouton ouvre une séance NEUVE avec le modèle dedans — exactement comme « + Séance », mais déjà rempli. Ce que vous aviez dans le builder n\'est pas concerné : le modèle ne s\'ajoute jamais à une séance déjà planifiée.' },
      ...
      { t:'« Ajouter tous les blocs » garde le découpage', x:'C\'est le seul chemin qui importe les étapes du modèle : là, le découpage fait sens puisque vous reprenez la séance entière.' },
      ...
      { t:'« Mettre à jour le modèle »', x:'Ce bouton n\'apparaît que si le modèle est seul dans la séance en cours de composition. Dès que vous composez à partir de plusieurs sources, la séance n\'est plus ce modèle : le bouton propose alors d\'en enregistrer un nouveau, pour ne pas écraser l\'original avec autre chose.' },
