...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Réutiliser une séance : les templates',
    ...
    etapes:[
      ...
      { t:'Enregistrer la séance en cours comme template', x:'Nom, étiquettes, catégorie et emoji. Vous pouvez aussi la rattacher à un protocole en lui donnant un numéro de phase — elle devient alors une étape de ce parcours.' },
