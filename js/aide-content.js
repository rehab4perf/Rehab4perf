...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Les répertoires d\'exercices',
    ...
    etapes:[
      ...
      { t:'« Ouvrir dans le builder »', x:'Dans la carte dépliée, ce bouton est le seul geste qui compose quelque chose : il ajoute le contenu du répertoire à la séance actuellement en cours dans le builder. C\'est un choix explicite, jamais le résultat d\'un simple clic de consultation.' },
