...
{ id:'bilan', emoji:'🩺', titre:'Bilan clinique', articles:[
  ...
  { id:'mob-actif-passif', titre:'Amplitudes actif / passif — le raisonnement',
    intro:'Trois menus par mouvement — actif, passif, fin de course — et l\'interprétation s\'écrit toute seule. Épaule, Coude, Poignet et Hanche.',
    etapes:[
      { t:'Pourquoi comparer les deux', x:'Un mouvement limité en actif mais libre en passif ne dit pas la même chose qu\'un mouvement limité dans les deux cas : le premier oriente vers la force ou le contrôle, le second vers le tissu. La colonne « Interprétation » l\'écrit pour vous, avec sa raison en une ligne.' },
      { t:'Les quatre profils', x:'Actif et passif limités → « Limitation articulaire ». Actif inférieur au passif → « Limitation musculaire ». Actif supérieur au passif → « Artefact ou laxité », à remesurer. Douleur active sans limitation passive → « Pathologie tendineuse ».' },
      { t:'La fin de course affine le verdict', x:'« Dur » requalifie en « Butée osseuse » — l\'amplitude ne se regagne pas. « Mou » en « Œdème ou laxité » — traiter la cause d\'abord. « Ferme-élastique » laisse le verdict de base. Le menu ne s\'active qu\'une fois le passif renseigné.' },
      { t:'Douleur sans limitation', x:'Douloureux en actif comme en passif, ou douloureux seulement quand vous mobilisez : « Structure non contractile » — capsule, ligament ou bourse. Ce qui fait mal ne se contracte pas, la douleur ne vient donc ni du muscle ni du tendon.' },
      { t:'« Vide (arrêt sur douleur) » est un signal, pas une raideur', x:'La douleur arrête le mouvement avant toute butée : rupture massive, tumeur ou capsulite. Ce choix prend le pas sur tout le reste de la ligne, quel que soit l\'actif, et le compte-rendu le nomme.' },
      { t:'La hanche garde ses deux côtés', x:'Chaque mouvement y occupe deux lignes, gauche et droite, systématiquement — c\'est la seule région où la comparaison des côtés fait partie de l\'examen. Ses six angles en degrés ont été retirés : vous notez l\'amplitude en clair dans le marqueur quand elle compte. Vos courbes de mobilité de hanche déjà tracées restent visibles dans l\'Évolution ; elles ne gagnent simplement plus de nouveaux points.' },
      { t:'Où le trouver', x:'Dans les blocs de mobilité de l\'Épaule, du Coude, du Poignet et de la Hanche. La colonne « Marqueur / observations » reçoit le secteur qui reproduit la plainte.' },
      { t:'Ce qui a changé dans vos anciens bilans', x:'Aucune valeur n\'a bougé — les verdicts sont recalculés à chaque affichage. Seuls les mots changent : « Restriction structurelle » se lit désormais « Limitation articulaire », « Déficit actif » se lit « Limitation musculaire ». La fin de course y est inconnue, donc le verdict de base s\'applique.' },
      { t:'La page Coude apparaît enfin au compte-rendu', x:'Elle n\'y figurait dans AUCUNE section : ses tests de compartiment et sa mobilité pouvaient être remplis sans qu\'une seule ligne n\'en sorte. Vos bilans déjà enregistrés retrouvent ces données.' }
    ]},
  ...
  { id:'analyse-course', titre:'Analyser une course à pied',
    ...
    etapes:[
      ...
      { t:'La cadence est le seul chiffre à saisir', x:'Comptez les appuis d\'un seul pied pendant 30 secondes et multipliez par 4. Toute montre GPS l\'affiche aussi, et Strava l\'enregistre déjà pour les activités synchronisées.' },
      { t:'180 est une référence, pas un objectif à atteindre', x:'La page constate, elle ne prescrit pas : 180 pas/min est la référence mondiale en performance, et en deçà de 165 la cadence est notée insuffisante. Aucune cible de progression n\'est calculée — un coureur déjà à 180 ne se verra rien demander.' },
      { t:'Contact au sol, symétrie et oscillation : ce que vous OBSERVEZ', x:'Ces trois-là ne se mesurent pas à l\'œil — un temps de contact, c\'est un quart de seconde. Vous cochez donc ce que vous voyez et entendez : appui bref ou pied qui s\'écrase, foulée symétrique ou rythme qui boite, course rasante ou coureur qui rebondit. Un appui plus sonore que l\'autre est une observation clinique valable.' },
      { t:'Le chiffre reste possible, en appoint', x:'Un champ facultatif accompagne chacun de ces trois critères. Il se remplit dans deux cas : le coureur porte un capteur (ceinture Garmin HRM-Pro, pod Running Dynamics, Stryd, montre Coros), ou vous comptez les images d\'un ralenti — un iPhone filme à 240 im/s, soit 4,2 ms par image ; comptez de la pose au décollement et multipliez par 4,17. Sans capteur, le statut observé suffit : c\'est lui qui déclenche les points à travailler.' },
      { t:'Cliquez sur le schéma d\'attaque du pied', x:'Trois positions par rapport au centre de masse : sous, devant (overstride), derrière. Plus le pied se pose devant, plus la force de freinage est grande à chaque appui — et cela se corrige par la cadence, pas par une consigne sur le pied.' },
      { t:'Re-cliquer la position retenue l\'annule', x:'Ce schéma n\'a pas d\'option « vide » : c\'est le second clic sur la position déjà choisie qui la retire. La mention apparaît sur la carte sélectionnée pour vous le rappeler.' },
  ...
  { id:'generer-cr', titre:'Générer un compte-rendu',
    ...
    etapes:[
      ...
      { t:'Un bilan ancien porte le même marquage', x:'Consulter un bilan de juin depuis « Bilans précédents » affiche désormais ses mentions par rapport aux bilans qui le précédaient — auparavant un CR ancien s\'affichait entièrement sans distinction, comme si tout y avait été mesuré le même jour.' }
    ]},
  { id:'sauvegarder-bilan', titre:'Sauvegarder, modifier et suivre un bilan',
    ...
    etapes:[
      { t:'La date du bilan ne se saisit pas, elle se lit', x:'Un bilan est TOUJOURS daté du jour où vous l\'enregistrez. Le champ « Date du bilan » a été retiré du formulaire : il ne pilotait rien, et affichait souvent autre chose que la vraie date — la date du jour pendant que vous corrigiez un bilan de juin, ou une valeur figée après une correction faite depuis « Bilans précédents ». C\'était la cause des dates incohérentes dans les comptes-rendus.' },
      { t:'Où voir la date pendant que vous remplissez', x:'La pastille « Bilan du … » sous le nom du patient, en haut à gauche, la porte en permanence. Elle passe en ambre dès que le bilan consulté n\'est pas celui du jour — vous ne pouvez plus croire écrire à la date d\'aujourd\'hui sans le voir. Pour corriger une date, passer par « Bilans précédents ».' },
      ...
      { t:'Les anciens résultats restent affichés en fond', x:'Sur un bilan de suivi, chaque champ est vide mais montre en gris italique la dernière valeur connue — résultats, repères, observations, menus déroulants. Rien n\'est enregistré tant que vous n\'avez pas saisi : la valeur affichée disparaît à la première frappe.' },
      { t:'Les cases à cocher aussi, par un anneau', x:'Une case ne peut pas porter de texte en fond. Celles qui étaient cochées au bilan précédent sont donc entourées d\'un liseré gris en pointillés — analyse fonctionnelle, Test de Réception, pliométrie qualitative, instabilité au SEBT. La case reste vide : l\'anneau dit « c\'était coché la dernière fois », il ne coche rien et n\'enregistre rien. Il part au premier clic. Une case qui était DÉCOCHÉE n\'affiche rien : le bilan enregistre toutes les cases à chaque fois, si bien qu\'une case non cochée est indiscernable d\'un test jamais évalué — la marquer ne dirait rien.' },
...
{ id:'outils', emoji:'🛠', titre:'Outils & CR médecin', articles:[
  ...
  { id:'cr-force-medecin', titre:'La force dans le CR médecin',
    ...
    etapes:[
      ...
      { t:'Comment les tests sont nommés au médecin', x:'Deux éléments : la fonction mesurée (« Contrôle du membre inférieur ») et, en petit juste dessous, le geste réalisé (« squat sur une jambe »). Le nom du protocole figurait un temps entre parenthèses — « Contrôle du membre inférieur (Squat unipodal) » — il a été retiré : il alourdissait l\'intitulé sans rien apprendre au médecin.' }
    ]},
  { id:'cr-colonnes', titre:'Les colonnes du tableau des tests',
    ...
    etapes:[
      ...
      { t:'Un bon résultat s\'affiche en vert', x:'« Aucune compensation » sortait en orange — la couleur d\'une alerte pour le meilleur résultat possible. Plus largement, une ligne que vous n\'avez pas jugée s\'affiche désormais en gris et non en orange : le courrier ne signale plus au médecin une inquiétude que vous n\'avez pas exprimée.' },
      { t:'L\'asymétrie reste affichée', x:'La colonne « Asym. » suit les tests chiffrés même lorsqu\'un test à grille — le Test de Réception, par exemple — figure dans le même groupe. Sa présence effaçait auparavant les colonnes de tout le tableau.' },
  ...
  { id:'cr-mise-en-page', titre:'Le courrier à l\'impression',
    ...
    etapes:[
      { t:'Synthèse et plan sont deux encadrés jumeaux', x:'Le plan sortait en paragraphes nus juste sous la conclusion, et l\'on ne voyait plus où l\'une finissait. Chacun a désormais son intitulé et son filet de couleur : l\'un dit où en est le patient, l\'autre ce qui va être fait. Le premier s\'appelle « Synthèse clinique » — « Conclusion » ne disait pas de quoi. Le fond gris a été retiré : sur papier, un aplat vieillit mal, et deux filets horizontaux très fins suffisent à borner le bloc.' },
...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'etapes', titre:'Regrouper des blocs en étapes',
    ...
    etapes:[
      ...
      { t:'Enregistrez une étape comme modèle', x:'Le bouton dédié sauvegarde uniquement les blocs de cette étape, pas toute la séance — pratique pour réutiliser un échauffement type. Comme tout modèle, il s\'ajoutera ensuite à la séance en cours, en copie indépendante et sans lien avec l\'original.' },
  ...
  { id:'templates', titre:'Les modèles d\'exercices',
    intro:'Un modèle n\'est pas une séance toute prête : c\'est une sélection d\'exercices retenus pour un profil — une bibliothèque affinée, extraite de la grande. On ne l\'envoie pas au patient, on y pioche pour composer sa séance. Un modèle peut tenir en un bloc, une étape, ou une séance entière.',
    etapes:[
      { t:'Consulter un modèle depuis l\'agenda', x:'Cliquez sur sa carte : elle se déplie sur place et montre ses blocs et exercices. Le clic ne redirige plus vers le builder — vous regardez avant de choisir.' },
      { t:'« Modifier le modèle »', x:'Dans la carte dépliée du répertoire — et par le crayon ✎ de la bibliothèque du builder — ce bouton ouvre le modèle LUI-MÊME : ce que vous y changez s\'enregistre dans le modèle, par « Mettre à jour le modèle ». C\'est le seul chemin vers cette mise à jour. Si une séance non enregistrée était en cours dans le builder, on vous le demande avant de la fermer.' },
      { t:'Planifier directement, sans passer par le builder', x:'Le bouton « + » sur une carte crée une copie du modèle pour le patient sélectionné, puis ouvre le même écran que « Planifier » depuis le builder : « Cocher les jours sur l\'agenda » en premier, la saisie date par date en repli. C\'est le même geste des deux côtés, avec ou sans passage par le builder.' },
      { t:'Un modèle s\'ajoute, il ne remplace jamais', x:'Son contenu vient s\'ajouter à la suite de la séance en cours. Rien n\'est écrasé, donc rien ne se perd sans que vous l\'ayez demandé. Si vous voulez repartir du modèle seul, videz la séance d\'abord : « Vider » est là pour ça.' },
      { t:'Composer une séance à partir de plusieurs modèles', x:'C\'est le geste central : dans le builder, l\'onglet Modèles permet de piocher un échauffement type, puis un bloc de renforcement, puis un finisher — chacun venant d\'un modèle différent. Chaque ajout est une copie indépendante, modifier l\'une ne touche pas l\'original.' },
      { t:'Les étapes suivent leur contenu', x:'Si le modèle contient des étapes, elles arrivent avec lui, sous leur nom et leur couleur. Elles ne se mélangent pas avec celles déjà en place. Un modèle sans étape s\'ajoute hors étape, même si votre séance se terminait par une.' },
      { t:'Piocher un seul bloc plutôt que tout le modèle', x:'Dans l\'onglet Modèles du builder, dépliez un modèle pour voir ses blocs et ajoutez celui qui vous intéresse. Vous pouvez aussi n\'ajouter qu\'un exercice. Le reste du modèle n\'est pas touché.' },
      { t:'Un bloc pioché n\'apporte pas son étape', x:'Une étape est un découpage de la séance, pas une propriété du bloc. Un bloc pioché arrive donc comme un bloc créé par « + Ajouter » : il rejoint l\'étape ouverte en fin de séance s\'il y en a une, sinon aucune. Piochez-en deux, ils se suivent — au lieu de créer deux étapes du même nom.' },
      { t:'« Ajouter à la séance » : une copie, étapes comprises', x:'Dans la bibliothèque du builder, dépliez un modèle : « + Ajouter à la séance » le copie dans la séance en cours, étapes comprises. Il ne change jamais sa nature, même si elle est vide : elle reste la séance du patient, que vous enregistrez ou planifiez. Le modèle, lui, n\'est pas touché.' },
      { t:'Une séance vide : « Partir d’un modèle »', x:'Une séance sans contenu propose deux départs : « + Ajouter un bloc », ou « Partir d’un modèle », qui ouvre le panneau latéral sur l’onglet Modèles. Dépliez un modèle, puis « + Ajouter à la séance ».' },
      { t:'Créer un modèle de zéro', x:'Le bouton « Nouveau modèle », en haut du panneau Modèles, ouvre le builder vide, sans patient ni date : vous composez, puis « Enregistrer le modèle ». Si une séance était en cours dans le builder, elle est mise de côté et vous la retrouvez intacte en sortant — rien n\'est effacé.' },
      { t:'Le bandeau dit ce que vous modifiez', x:'Le titre de l\'en-tête dit quelle séance vous composez (« Séance du 15 septembre ») ; le patient se lit dans la barre de l\'application, tout en haut. Un bandeau ambre « Modification d’un modèle — aucun patient n\'est concerné » : vous modifiez le modèle, et le bouton principal devient « Mettre à jour le modèle ». De là, « Quitter le modèle » en sort sans rien écrire, et « Utiliser pour un patient » copie le modèle dans une séance du patient sélectionné, que vous planifiez ensuite.' },
      { t:'Étiquetez la pathologie et le sport', x:'Deux champs libres à l\'enregistrement — « LCA », « course à pied ». Ce sont eux qui permettront de retrouver le bon modèle : un nom se lit, il ne se filtre pas. Les étiquettes déjà utilisées vous sont proposées, pour éviter que « LCA » et « L.C.A. » coexistent sans le vouloir.' },
      { t:'Un protocole étiquette toutes ses phases', x:'Renseignez la pathologie sur le protocole plutôt que sur chacune de ses phases : elles en héritent. Une phase peut porter sa propre étiquette si elle diffère — la sienne l\'emporte alors.' },
      { t:'Seuls le nom et les étiquettes sont demandés', x:'Catégorie, protocole, numéro de phase et emoji sont regroupés sous « Classement », replié : ils servent à ranger, aucun n\'est obligatoire.' },
      { t:'Ajouter une phase à un protocole', x:'« Nouvelle phase » sous un protocole ouvre le même builder vide, avec le protocole et le numéro de phase déjà remplis. Une phase n\'est rien d\'autre qu\'un modèle rangé dans un protocole.' }
    ]},
  ...
  { id:'colonne-patient', titre:'La colonne Patient',
    intro:'À gauche de l\'agenda, l\'essentiel du patient sélectionné, sans ouvrir d\'autre écran.',
    etapes:[
      { t:'Cycle en cours', x:'Le cycle actif, sa semaine et sa date de fin. « Cycles » ouvre la liste, « + Nouveau cycle » en crée un.' },
      { t:'Échéances', x:'Les objectifs à venir avec leur J-N : la distance, qui donne le budget de semaines pour caler les cycles.' },
      { t:'Charge', x:'L\'ACWR et sa jauge — sous-charge sous 0,8, zone optimale de 0,8 à 1,3, vigilance puis surcharge au-delà —, puis la charge des 7 derniers jours et la charge chronique. « Évolution » ouvre les courbes.' },
      { t:'Derniers retours', x:'Les derniers ressentis de l\'athlète, RPE et EVA. « Journal » ouvre le fil complet.' },
      { t:'À venir', x:'Les prochaines séances planifiées.' },
      { t:'Replier la colonne', x:'Un clic sur l\'onglet déjà actif — Patient ou Modèles — la replie en un rail étroit, et l\'agenda prend la place. Un clic sur un onglet du rail la rouvre. L\'état est retenu. Même geste dans le builder, avec Exercices et Modèles.' },
      { t:'Partager au patient', x:'Le bouton « Partager », en haut de l\'agenda, copie le lien de son calendrier — voir « Espace athlète ».' }
    ]},
  { id:'cycles', titre:'Créer des cycles d\'entraînement',
    ...
    etapes:[
      { t:'Ouvrez le panneau Cycles', x:'Depuis la carte « Cycle en cours » de la colonne Patient : « Cycles » ouvre la liste, « + Nouveau cycle » le formulaire. Nom, couleur, note, et le choix entre « Durée fixe » et « Critères » en haut du formulaire.', img:true },
  ...
  { id:'journal-evolution', titre:'Journal et Évolution',
    ...
    etapes:[
      ...
      { t:'Évolution : choisissez la période', x:'Une unité — Semaine, Mois, Trimestre, Année, Cycle —, puis ‹ › pour reculer ou avancer, jamais au-delà d’aujourd’hui ; « Aujourd’hui » ramène à la période en cours. Au clavier : ← →. Sur iPad : glissez. « Tout » couvre tout l’historique, « Personnalisé » une plage de dates. Votre unité est retenue d’une ouverture à l’autre.', svg:'<svg viewBox="0 0 600 130" role="img" aria-label="Sélecteur de période : les unités Semaine, Mois, Trimestre, Année, Cycle et Tout, puis des flèches autour de « Août 2026 » et le bouton Aujourd’hui qui ramène à la période en cours"> <rect width="600" height="130" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="114" rx="10" fill="#fff" stroke="#dde3ec"/> <rect x="18" y="20" width="400" height="34" rx="8" fill="#fff" stroke="#C6D0DE"/> <rect x="98" y="20" width="60" height="34" fill="#1A3A5C"/> <g stroke="#C6D0DE"><line x1="98" y1="20" x2="98" y2="54"/><line x1="158" y1="20" x2="158" y2="54"/><line x1="248" y1="20" x2="248" y2="54"/><line x1="308" y1="20" x2="308" y2="54"/><line x1="363" y1="20" x2="363" y2="54"/></g> <g font-size="14.5" font-weight="700" text-anchor="middle" fill="#6b7a8d"><text x="58" y="42">Semaine</text><text x="128" y="42" fill="#fff">Mois</text><text x="203" y="42">Trimestre</text><text x="278" y="42">Année</text><text x="335" y="42">Cycle</text><text x="390" y="42">Tout</text></g> <rect x="18" y="72" width="34" height="34" rx="8" fill="#fff" stroke="#C6D0DE"/><text x="35" y="95" font-size="17" font-weight="700" fill="#1A3A5C" text-anchor="middle">‹</text> <text x="130" y="95" font-size="16" font-weight="700" fill="#1A3A5C" text-anchor="middle">Août 2026</text> <rect x="208" y="72" width="34" height="34" rx="8" fill="#fff" stroke="#C6D0DE"/><text x="225" y="95" font-size="17" font-weight="700" fill="#1A3A5C" text-anchor="middle">›</text> <rect x="256" y="74" width="128" height="30" rx="15" fill="#fff" stroke="#C6D0DE"/><text x="320" y="94" font-size="14.5" font-weight="700" fill="#2B5FA6" text-anchor="middle">Aujourd’hui</text> <rect x="476" y="74" width="106" height="30" rx="15" fill="#fff" stroke="#C6D0DE"/><text x="529" y="94" font-size="14.5" fill="#6b7a8d" text-anchor="middle">Réalisé</text> </svg>' },
      { t:'La charge suit la période', x:'Volume par sport, répartition et charge UA portent sur la période choisie, comparée à la précédente — coupée au même jour si elle est en cours (1 → 11 sept. contre 1 → 11 août). Survolez un pourcentage : la bulle dit à quoi il se compare. Cliquez une barre pour ouvrir sa semaine ou son mois.' },
      { t:'La progression garde son histoire', x:'Charge estimée, douleur EVA, durées, cardio : les courbes montrent toute la rééducation, la période choisie en bande bleue, et les chiffres de tête portent sur la période. « Période seule » pour zoomer. Au poids du corps, l’écart se compte en répétitions ; au passage en charge, il repart de la première séance chargée.', svg:'<svg viewBox="0 0 600 304" role="img" aria-label="Courbes par exercice : la charge du back squat (1RM estimé) monte de 62 à 88 kg pendant que la douleur EVA descend de 3 à 1 sur 10 ; août est surligné d’une bande sur la courbe de toute la rééducation"> <rect width="600" height="304" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="288" rx="10" fill="#fff" stroke="#dde3ec"/> <g font-size="14.5" font-weight="700"> <rect x="18" y="18" width="146" height="32" rx="16" fill="#EEF3FB" stroke="#2B5FA6"/><text x="32" y="39" fill="#1A3A5C">☑ Back squat</text> <rect x="172" y="18" width="176" height="32" rx="16" fill="#EEF3FB" stroke="#2B5FA6"/><text x="186" y="39" fill="#1A3A5C">☑ Bulgarian lunge</text> <rect x="356" y="18" width="122" height="32" rx="16" fill="#fff" stroke="#dde3ec"/><text x="370" y="39" fill="#6b7a8d">☐ Hip thrust</text> <rect x="490" y="18" width="92" height="32" rx="16" fill="#1A3A5C"/><text x="536" y="39" fill="#fff" text-anchor="middle">Août</text> </g> <text x="24" y="84" font-size="17" font-weight="700" fill="#1A3A5C">Back squat</text> <line x1="322" y1="79" x2="344" y2="79" stroke="#2B5FA6" stroke-width="3" stroke-linecap="round"/> <text x="350" y="84" font-size="14.5" fill="#1a2433">Charge 1RM (kg)</text> <line x1="474" y1="79" x2="496" y2="79" stroke="#7C3AED" stroke-width="2.4" stroke-dasharray="5 3" stroke-linecap="round"/> <text x="502" y="84" font-size="14.5" fill="#1a2433">EVA /10</text> <g stroke="#EEF1F5" stroke-width="1.5"><line x1="56" y1="110" x2="540" y2="110"/><line x1="56" y1="185" x2="540" y2="185"/></g> <rect x="255" y="96" width="220" height="164" rx="6" fill="#2B5FA6" fill-opacity=".08"/> <line x1="56" y1="260" x2="540" y2="260" stroke="#dde3ec" stroke-width="2"/> <g font-size="14" fill="#6b7a8d" text-anchor="end"><text x="48" y="115">100</text><text x="48" y="190">70</text><text x="48" y="265">40</text></g> <g font-size="14" fill="#7C6BC9" text-anchor="start"><text x="548" y="115">10</text><text x="548" y="190">5</text><text x="548" y="265">0</text></g> <path d="M90 205 L200 190 L310 172.5 L420 155 L520 140 L520 260 L90 260 Z" fill="#2B5FA6" fill-opacity=".12"/> <path d="M90 205 L200 190 L310 172.5 L420 155 L520 140" fill="none" stroke="#2B5FA6" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round"/> <path d="M90 215 L200 230 L310 230 L420 245 L520 245" fill="none" stroke="#7C3AED" stroke-width="2.2" stroke-dasharray="6 4" stroke-linecap="round"/> <g fill="#2B5FA6" stroke="#fff" stroke-width="2"><circle cx="90" cy="205" r="6"/><circle cx="200" cy="190" r="6"/><circle cx="310" cy="172.5" r="6"/><circle cx="420" cy="155" r="6"/><circle cx="520" cy="140" r="6"/></g> <g fill="#7C3AED" stroke="#fff" stroke-width="1.8"><circle cx="90" cy="215" r="5"/><circle cx="200" cy="230" r="5"/><circle cx="310" cy="230" r="5"/><circle cx="420" cy="245" r="5"/><circle cx="520" cy="245" r="5"/></g> <g font-size="14.5" font-weight="700" fill="#1A3A5C" text-anchor="middle"> <text x="90" y="189">62</text><text x="200" y="174">68</text><text x="310" y="156">75</text><text x="420" y="139">82</text><text x="520" y="124">88 kg</text> </g> <text x="104" y="242" font-size="14.5" font-weight="700" fill="#7C3AED">3/10</text> <text x="520" y="232" font-size="14.5" font-weight="700" fill="#7C3AED" text-anchor="middle">1/10</text> <g font-size="14" fill="#6b7a8d" text-anchor="middle"><text x="90" y="284">8 juil</text><text x="200" y="284">22 juil</text><text x="310" y="284">5 août</text><text x="420" y="284">19 août</text><text x="520" y="284">2 sep</text></g> </svg>' },
  ...
  { id:'feedback', titre:'Lire le retour d\'un athlète',
    ...
    etapes:[
      { t:'Ouvrez la séance concernée', x:'Le bouton « Feedback » apparaît dans la barre du builder dès que la séance est enregistrée, et porte un point bleu si l\'athlète a laissé un retour. Vous pouvez aussi y saisir vous-même le ressenti d\'une séance faite au cabinet.', img:true },
...
{ id:'charges', emoji:'⚡', titre:'Charge d\'entraînement', articles:[
  { id:'ua-foster', titre:'Les UA : comment la charge est calculée',
    ...
    etapes:[
      { t:'UA = RPE × durée', x:'Le ressenti d\'effort de l\'athlète (Borg 1–10) multiplié par la durée réelle en minutes. Une séance de 45 min à RPE 7 = 315 UA. C\'est la méthode de Foster, celle sur laquelle sont calibrés tous les seuils du bilan — zone favorable ACWR, monotonie, contrainte.' },
  ...
  { id:'bilan-charge', titre:'Lire le Bilan de charge (sous l\'agenda)',
    intro:'Le tableau de bord de la charge : trois chiffres, les deux dernières semaines jour par jour, et la tendance de l\'ACWR.',
    etapes:[
      { t:'Trois chiffres en tête', x:'La charge des 7 derniers jours ; la semaine en cours, comparée à jour égal — du lundi à aujourd\'hui, contre le même intervalle de la semaine d\'avant (un vendredi ne se compare plus à une semaine entière) ; la monotonie des 7 derniers jours, avec la contrainte en complément.' },
      { t:'Deux semaines, une seule échelle', x:'Chaque jour porte sa charge en UA au-dessus de sa barre, et une même hauteur veut dire la même charge d\'une semaine à l\'autre. Les jours à venir sont en pointillé : ce ne sont pas des jours de repos. La couleur ne juge plus un jour isolé — un profil en dents de scie est normal, et même souhaitable.', svg:'<svg viewBox="0 0 600 300" role="img" aria-label="Bilan de charge : deux semaines côte à côte sur la même échelle, la valeur en UA au-dessus de chaque barre, samedi et dimanche à venir en pointillé"> <rect width="600" height="300" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="284" rx="10" fill="#fff" stroke="#dde3ec"/> <text x="24" y="40" font-size="15" font-weight="700" fill="#1A3A5C">31 août – 6 sept</text> <text x="290" y="40" font-size="15" font-weight="800" fill="#2B5FA6" text-anchor="end">3 148 UA</text> <line x1="24" y1="222" x2="290" y2="222" stroke="#dde3ec" stroke-width="2"/> <rect x="30" y="144.5" width="26" height="77.5" rx="4" fill="#2B5FA6"/> <text x="43" y="138.5" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">460</text> <text x="43" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">L 31</text> <rect x="68" y="178.2" width="26" height="43.8" rx="4" fill="#2B5FA6"/> <text x="81" y="172.2" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">260</text> <text x="81" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">M 1</text> <rect x="106" y="178.2" width="26" height="43.8" rx="4" fill="#2B5FA6"/> <text x="119" y="172.2" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">260</text> <text x="119" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">M 2</text> <rect x="144" y="94" width="26" height="128" rx="4" fill="#2B5FA6"/> <text x="157" y="88" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">760</text> <text x="157" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">J 3</text> <rect x="182" y="178.2" width="26" height="43.8" rx="4" fill="#2B5FA6"/> <text x="195" y="172.2" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">260</text> <text x="195" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">V 4</text> <rect x="220" y="144.5" width="26" height="77.5" rx="4" fill="#2B5FA6"/> <text x="233" y="138.5" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">460</text> <text x="233" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">S 5</text> <rect x="258" y="106.1" width="26" height="115.9" rx="4" fill="#2B5FA6"/> <text x="271" y="100.1" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">688</text> <text x="271" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">D 6</text> <text x="310" y="40" font-size="15" font-weight="700" fill="#1A3A5C">7 – 13 sept · en cours</text> <text x="576" y="40" font-size="15" font-weight="800" fill="#2B5FA6" text-anchor="end">1 795 UA</text> <line x1="310" y1="222" x2="576" y2="222" stroke="#dde3ec" stroke-width="2"/> <rect x="316" y="158" width="26" height="64" rx="4" fill="#2B5FA6"/> <text x="329" y="152" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">380</text> <text x="329" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">L 7</text> <rect x="354" y="188.3" width="26" height="33.7" rx="4" fill="#2B5FA6"/> <text x="367" y="182.3" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">200</text> <text x="367" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">M 8</text> <rect x="392" y="158" width="26" height="64" rx="4" fill="#2B5FA6"/> <text x="405" y="152" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">380</text> <text x="405" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">M 9</text> <rect x="430" y="179.9" width="26" height="42.1" rx="4" fill="#2B5FA6"/> <text x="443" y="173.9" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">250</text> <text x="443" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">J 10</text> <rect x="468" y="123.5" width="26" height="98.5" rx="4" fill="#2B5FA6"/> <text x="481" y="117.5" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">585</text> <text x="481" y="242" font-size="14" fill="#2B5FA6" font-weight="800" text-anchor="middle">V 11</text> <rect x="506" y="188" width="26" height="34" rx="4" fill="none" stroke="#9aa7b8" stroke-dasharray="4 3"/> <text x="519" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">S 12</text> <rect x="544" y="188" width="26" height="34" rx="4" fill="none" stroke="#9aa7b8" stroke-dasharray="4 3"/> <text x="557" y="242" font-size="14" fill="#6b7a8d" font-weight="400" text-anchor="middle">D 13</text> <text x="519" y="180" font-size="14" fill="#6b7a8d" text-anchor="middle">à venir</text> <text x="24" y="276" font-size="14.5" fill="#6b7a8d">Même hauteur = même charge d’une semaine à l’autre. Pointillé = à venir.</text> </svg>' },
      { t:'Monotonie : la variabilité', x:'Charge moyenne ÷ écart-type, sur les 7 derniers jours. En dessous de 1,5 : bonne variabilité. Entre 1,5 et 2 : vigilance. Au-dessus de 2 : monotonie élevée — des charges trop uniformes augmentent le risque de blessure et de surmenage, même à volume modéré.' },
      { t:'Contrainte (strain)', x:'Charge des 7 derniers jours × monotonie. Deux semaines à volume égal ne se valent pas : celle qui est monotone contraint plus l\'organisme.' },
      { t:'La comparaison à la semaine précédente', x:'Jusqu\'à +10 % : progression sûre (vert). De +10 à +15 % : à surveiller (orange). Au-delà de +15 % : hausse trop brutale (rouge). Une baisse reste en vert.' },
      { t:'Adhérence 30 jours', x:'La part des séances planifiées réellement réalisées (retour athlète ou activité Strava à l\'appui).' },
      { t:'Un mois passé', x:'En naviguant vers un mois passé, le bilan se lit à son dernier dimanche, et la date est écrite sous le titre (« lu au 30 août »).' }
    ]},
  { id:'acwr', titre:'L\'ACWR : le ratio charge aiguë / chronique',
    intro:'L\'indicateur clé du risque lié aux variations de charge — affiché dans le Bilan de charge, avec sa tendance sur 8 semaines.',
    etapes:[
      ...
      { t:'Les zones', x:'Moins de 0,8 : sous-charge (désentraînement possible). De 0,8 à 1,3 : sweet spot — la zone où viser. De 1,3 à 1,5 : prudence. Au-delà de 1,5 : zone à risque — la charge récente dépasse nettement ce que l\'organisme a l\'habitude d\'encaisser.' },
      { t:'La tendance sur 8 semaines', x:'Chaque barre est la charge d\'une semaine ; le pointillé, la charge chronique (28 jours ÷ 4), qui relie les semaines ; la bande verte, la zone favorable de chaque semaine (0,8 à 1,3 × la chronique). Une semaine qui dépasse la bande passe en orange puis en rouge : on voit laquelle a fait monter le ratio. Sans 28 jours d\'historique, pas de bande — le ratio ne veut encore rien dire.', svg:'<svg viewBox="0 0 600 300" role="img" aria-label="Tendance de l’ACWR sur 8 semaines : une barre par semaine, la charge chronique en pointillé qui relie les semaines, la bande favorable en vert ; la semaine du 31 août dépasse la bande et passe en rouge"> <rect width="600" height="300" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="284" rx="10" fill="#fff" stroke="#dde3ec"/> <text x="24" y="36" font-size="14" font-weight="700" fill="#6b7a8d" letter-spacing=".06em">CHARGE PAR SEMAINE — 8 SEMAINES</text> <polygon points="265.5,128.5 334.5,128.5 403.5,128.5 472.5,101.7 541.5,92 541.5,143.6 472.5,149.5 403.5,166 334.5,166 265.5,166" fill="#D4EFDF"/> <rect x="41" y="151" width="35" height="75" rx="3" fill="#2B5FA6"/> <rect x="110" y="151" width="35" height="75" rx="3" fill="#2B5FA6"/> <rect x="179" y="151" width="35" height="75" rx="3" fill="#2B5FA6"/> <rect x="248" y="151" width="35" height="75" rx="3" fill="#2B5FA6"/> <rect x="317" y="151" width="35" height="75" rx="3" fill="#2B5FA6"/> <rect x="386" y="151" width="35" height="75" rx="3" fill="#2B5FA6"/> <rect x="455" y="68.6" width="35" height="157.4" rx="3" fill="#B91C1C"/> <rect x="524" y="136.3" width="35" height="89.7" rx="3" fill="#2B5FA6" opacity=".35"/> <polyline points="265.5,151 334.5,151 403.5,151 472.5,130.4 541.5,123" fill="none" stroke="#15803D" stroke-width="2.5" stroke-dasharray="6 4" stroke-linejoin="round"/> <line x1="24" y1="226" x2="576" y2="226" stroke="#dde3ec" stroke-width="2"/> <text x="58.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">20/7</text> <text x="58.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 500</text> <text x="127.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">27/7</text> <text x="127.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 500</text> <text x="196.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">3/8</text> <text x="196.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 500</text> <text x="265.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">10/8</text> <text x="265.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 500</text> <text x="334.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">17/8</text> <text x="334.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 500</text> <text x="403.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">24/8</text> <text x="403.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 500</text> <text x="472.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">31/8</text> <text x="472.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">3 148</text> <text x="541.5" y="244" font-size="14" fill="#6b7a8d" text-anchor="middle">7/9</text> <text x="541.5" y="262" font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle">1 795</text> <text x="472.5" y="60.6" font-size="14" font-weight="700" fill="#B91C1C" text-anchor="middle">pic</text> <text x="24" y="284" font-size="14" fill="#6b7a8d">Bande verte : 0,8 à 1,3 × la chronique (pointillé). Pas de bande sans 28 jours d’historique.</text> </svg>' },
...
{ id:'athlete', emoji:'📱', titre:'Espace athlète', articles:[
  { id:'lien-athlete', titre:'Partager le calendrier à l\'athlète (ou à un confrère)',
    ...
    etapes:[
      ...
      { t:'Le lien de partage d\'un programme (bouton 📤)', x:'Dans le builder, menu ··· → « Programmes du patient » : le bouton 📤 de chaque programme copie de la même façon un lien à sens unique vers ce programme précis, avec le nom du patient inclus.' },
  ...
  { id:'push-athlete', titre:'Notifications push sur le téléphone de l\'athlète 🔔',
    ...
    etapes:[
      { t:'Ce qui déclenche une notification', x:'Planifier une nouvelle séance (quel que soit le mode : ajout rapide, modèle, builder, protocole/cycle), déplacer ou dupliquer une séance existante, et envoyer un message patient.' },
...
{ id:'strava', emoji:'🔶', titre:'Strava', articles:[
  ...
  { id:'liaison-auto', titre:'Liaison automatique séance ↔ activité',
    ...
    etapes:[
      { t:'Course → séance CAP, vélo → séance Vélo', x:'La chip de la séance gagne un badge orange « S 4.7km 30min » : l\'activité est absorbée, l\'agenda reste lisible.', svg:'<svg viewBox="0 0 600 268" role="img" aria-label="Une course Strava rejoint la séance CAP du jour, un vélo rejoint la séance vélo : chaque séance porte un badge orange Strava"> <rect width="600" height="268" fill="#F7F9FC"/> <g font-weight="700"> <rect x="30" y="10" width="246" height="38" rx="19" fill="#FFF7ED" stroke="#FED7AA"/> <g transform="translate(44 17) scale(1)" fill="#FC4C02"><path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/></g> <text x="74" y="36" font-size="16.5" fill="#9A3412">Course · 4,7 km · 30 min</text> <rect x="318" y="10" width="258" height="38" rx="19" fill="#FFF7ED" stroke="#FED7AA"/> <g transform="translate(332 17) scale(1)" fill="#FC4C02"><path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/></g> <text x="362" y="36" font-size="16.5" fill="#9A3412">Vélo · 18,2 km · 45 min</text> </g> <g stroke="#FC4C02" stroke-width="2.4" stroke-dasharray="5 4" fill="none"><path d="M153 50 V74"/><path d="M447 50 V74"/></g> <g fill="#FC4C02"><path d="M146 72 L153 83 L160 72 Z"/><path d="M440 72 L447 83 L454 72 Z"/></g> <rect x="12" y="88" width="282" height="124" rx="10" fill="#fff" stroke="#dde3ec"/> <rect x="306" y="88" width="282" height="124" rx="10" fill="#fff" stroke="#dde3ec"/> <g font-size="14.5" font-weight="700" fill="#6b7a8d" letter-spacing=".05em"><text x="26" y="113">MARDI 8</text><text x="320" y="113">JEUDI 10</text></g> <rect x="22" y="126" width="262" height="42" rx="6" fill="#0d9488"/> <text x="34" y="153" font-size="17" font-weight="700" fill="#fff">🏃 Footing</text> <rect x="148" y="134" width="128" height="26" rx="4" fill="#FC4C02"/> <text x="212" y="152.5" font-size="16" font-weight="800" fill="#fff" text-anchor="middle">S 4.7km 30min</text> <rect x="316" y="126" width="262" height="42" rx="6" fill="#15803D"/> <text x="328" y="153" font-size="17" font-weight="700" fill="#fff">🚴 Vélo Z2</text> <rect x="432" y="134" width="138" height="26" rx="4" fill="#FC4C02"/> <text x="501" y="152.5" font-size="16" font-weight="800" fill="#fff" text-anchor="middle">S 18.2km 45min</text> <g font-size="14.5" fill="#6b7a8d"><text x="26" y="196">Liée automatiquement</text><text x="320" y="196">Liée automatiquement</text></g> <text x="300" y="248" font-size="16.5" fill="#1a2433" text-anchor="middle">Un seul repère par jour dans l’agenda.</text> </svg>' },
  ...
  { id:'lier-manuel', titre:'Lier ou délier manuellement',
    ...
    etapes:[
      { t:'Cliquez sur l\'activité orange', x:'Le détail propose « 🔗 Lier à une séance du jour » avec la liste des séances planifiées ce jour-là.', svg:'<svg viewBox="0 0 600 300" role="img" aria-label="Une activité Strava orange non liée : son détail propose de la lier à la séance planifiée ce jour-là"> <rect width="600" height="300" fill="#F7F9FC"/> <rect x="12" y="20" width="236" height="186" rx="10" fill="#fff" stroke="#dde3ec"/> <text x="26" y="46" font-size="14.5" font-weight="700" fill="#6b7a8d" letter-spacing=".05em">LUNDI 7</text> <rect x="22" y="60" width="216" height="42" rx="6" fill="#1D4ED8"/> <text x="34" y="87" font-size="17" font-weight="700" fill="#fff">💪 Renfo MI</text> <rect x="22" y="110" width="216" height="42" rx="6" fill="#FC4C02" opacity=".9"/> <text x="34" y="137" font-size="17" font-weight="700" fill="#fff">💪 Musculation</text> <rect x="22" y="110" width="216" height="42" rx="6" fill="none" stroke="#9A3412" stroke-width="2" stroke-dasharray="4 3"/> <path d="M206 140 l0 24 l6 -6 l5 11 l4 -2 l-5 -11 l8 0 z" fill="#1a2433" stroke="#fff" stroke-width="1.2"/> <text x="26" y="190" font-size="14.5" fill="#6b7a8d">Activité libre, non liée</text> <path d="M238 131 C 254 131, 254 78, 268 78" fill="none" stroke="#FC4C02" stroke-width="2.2" stroke-dasharray="5 4"/> <rect x="270" y="10" width="320" height="280" rx="12" fill="#fff" stroke="#dde3ec"/> <g transform="translate(286 27) scale(.95)" fill="#FC4C02"><path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/></g> <text x="314" y="46" font-size="19" font-weight="700" fill="#FC4C02">Musculation</text> <text x="286" y="74" font-size="14.5" fill="#6b7a8d">07/09/2026 · 52 min</text> <line x1="286" y1="90" x2="574" y2="90" stroke="#eef1f5" stroke-width="2"/> <text x="286" y="118" font-size="15" fill="#6b7a8d">Lier à une séance du jour :</text> <rect x="286" y="130" width="288" height="44" rx="7" fill="#fff" stroke="#FC4C02" stroke-width="2.2"/> <text x="302" y="158" font-size="17" font-weight="700" fill="#1a2433">🔗 Renfo MI</text> <line x1="286" y1="194" x2="574" y2="194" stroke="#eef1f5" stroke-width="2"/> <text x="286" y="222" font-size="15" fill="#b91c1c">✕ Délier · 🗑 Retirer</text> <text x="286" y="254" font-size="14.5" fill="#6b7a8d">Le lien vaut sur tous</text> <text x="286" y="274" font-size="14.5" fill="#6b7a8d">vos appareils.</text> </svg>' },
  ...
  { id:'panneau-strava', titre:'Le panneau « Réalisée avec Strava »',
    ...
    etapes:[
      { t:'Ouvrez la séance depuis l\'agenda', x:'Le panneau orange apparaît en tête : distance, durée, allure moyenne, FC moy/max, D+, charge, cadence.', svg:'<svg viewBox="0 0 600 352" role="img" aria-label="Panneau Réalisée avec Strava : tracé du parcours avec point de départ vert, chiffres de la sortie et allures kilomètre par kilomètre"> <rect width="600" height="352" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="336" rx="8" fill="#fff" stroke="#FED7AA"/> <path d="M16 8 H584 a8 8 0 0 1 8 8 V54 H8 V16 a8 8 0 0 1 8 -8 Z" fill="#FFF7ED"/> <rect x="8" y="8" width="4" height="336" rx="2" fill="#FC4C02"/> <g transform="translate(24 19) scale(.9)" fill="#FC4C02"><path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/></g> <text x="50" y="38" font-size="17.5" font-weight="700" fill="#9A3412">Réalisée avec Strava — Footing</text> <text x="548" y="38" font-size="14.5" fill="#C2410C" text-anchor="end">08/09/2026</text> <text x="572" y="38" font-size="15" fill="#C2410C" text-anchor="middle">▾</text> <path d="M42 210 C 28 170, 38 116, 78 100 C 114 86, 152 104, 152 138 C 152 160, 128 162, 120 180 C 112 200, 134 218, 108 228 C 82 238, 56 232, 42 210 Z" fill="none" stroke="#FC4C02" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round" opacity=".85"/> <circle cx="42" cy="210" r="7" fill="#22c55e"/> <text x="92" y="276" font-size="14" fill="#6b7a8d" text-anchor="middle" letter-spacing=".06em">PARCOURS</text> <text x="96" y="298" font-size="14.5" fill="#6b7a8d" text-anchor="middle">= départ</text> <circle cx="58" cy="293" r="5" fill="#22c55e"/> <line x1="172" y1="62" x2="172" y2="336" stroke="#eef1f5" stroke-width="2"/> <g font-weight="700" fill="#1a2433" font-size="19" text-anchor="middle"> <rect x="184" y="66" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="247" y="91">4,7 km</text> <rect x="316" y="66" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="379" y="91">30:12</text> <rect x="448" y="66" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="511" y="91">6:25</text> <rect x="184" y="124" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="247" y="149">148/171</text> <rect x="316" y="124" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="379" y="149">38 m</text> <rect x="448" y="124" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="511" y="149">212</text> <rect x="184" y="182" width="126" height="52" rx="7" fill="#F4F6F9" stroke="#E6EAF0"/><text x="247" y="207">168</text> </g> <g font-size="14" fill="#6b7a8d" text-anchor="middle"> <text x="247" y="111">DISTANCE</text><text x="379" y="111">DURÉE</text><text x="511" y="111">ALLURE/KM</text> <text x="247" y="169">FC MOY/MAX</text><text x="379" y="169">D+</text><text x="511" y="169">CHARGE</text> <text x="247" y="227">CADENCE</text> </g> <text x="330" y="208" font-size="14.5" font-weight="700" fill="#6b7a8d" letter-spacing=".05em">ALLURES PAR KM</text> <text x="330" y="228" font-size="14" fill="#6b7a8d">plus haute = plus rapide</text> <g fill="#FC4C02" opacity=".75"> <rect x="330" y="300" width="44" height="34" rx="3"/><rect x="380" y="292" width="44" height="42" rx="3"/> <rect x="430" y="286" width="44" height="48" rx="3"/><rect x="480" y="280" width="44" height="54" rx="3"/> <rect x="530" y="270" width="44" height="64" rx="3"/> </g> <g font-size="14" fill="#9A3412" text-anchor="middle" font-weight="700"> <text x="352" y="294">6:40</text><text x="402" y="286">6:28</text><text x="452" y="280">6:21</text><text x="502" y="274">6:18</text><text x="552" y="264">6:05</text> </g> </svg>' },
...
faq: [
  ...
  { q:'C\'est quoi, les UA ?',
    a:'Les Unités Arbitraires mesurent la charge d\'entraînement selon la méthode de Foster : RPE (effort perçu 1–10) × durée en minutes. Une séance de 45 min à RPE 7 = 315 UA. C\'est la formule sur laquelle sont calibrés les seuils affichés — zone favorable ACWR 0,8–1,3, monotonie, contrainte.' },
  { q:'C\'est quoi, le J0 ?',
