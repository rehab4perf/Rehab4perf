...
{ id:'bilan', emoji:'🩺', titre:'Bilan clinique', articles:[
  ...
  { id:'analyse-course', titre:'Analyser une course à pied',
    ...
    etapes:[
      ...
      { t:'La cible de cadence est RELATIVE, jamais 180', x:'La jauge calcule la cible à +5 à +10 % de la valeur mesurée. Le chiffre de 180 pas/min vient d\'une observation de coureurs d\'élite, pas d\'une norme validée — il n\'apparaît qu\'en repère grisé. Toutes les études d\'intervention ont testé une hausse relative depuis la valeur du coureur.' },
