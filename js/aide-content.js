...
{ id:'bilan', emoji:'🩺', titre:'Bilan clinique', articles:[
  ...
  { id:'mob-actif-passif', titre:'Amplitudes actif / passif — coude et poignet',
    ...
    etapes:[
      ...
      { t:'Il remplace les anciennes lignes de statut', x:'Les colonnes OK / Acceptable / Insuffisant et leurs marqueurs ont été retirées : deux façons de dire la mobilité dans le même bloc se lisaient comme un doublon. Ce qui y avait été saisi reste enregistré, mais n\'est plus affiché ni repris au compte-rendu. Les grilles de statut du Rachis, elles, sont inchangées — elles n\'ont pas d\'équivalent actif/passif.' },
