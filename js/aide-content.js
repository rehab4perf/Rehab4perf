...
{ id:'charges', emoji:'⚡', titre:'Charge d\'entraînement', articles:[
  ...
  { id:'bilan-charge', titre:'Lire le Bilan de charge (sous l\'agenda)',
    ...
    etapes:[
      { t:'Les barres quotidiennes', x:'La charge de chaque jour de la semaine. Vert < 150 UA, orange < 300, rouge au-delà — un profil en dents de scie est normal et même souhaitable.', svg:'<svg viewBox="0 0 600 300" role="img" aria-label="Bilan de charge d’une semaine : une barre par jour, verte sous 150 UA, orange jusqu’à 300, rouge au-delà, avec un profil en dents de scie"> <rect width="600" height="300" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="284" rx="10" fill="#fff" stroke="#dde3ec"/> <text x="24" y="42" font-size="17" font-weight="700" fill="#1A3A5C">7 sep – 13 sep</text> <text x="576" y="44" font-size="22" font-weight="800" fill="#2B5FA6" text-anchor="end">⚡ 990 UA</text> <line x1="40" y1="190" x2="560" y2="190" stroke="#dde3ec" stroke-width="2"/> <g> <rect x="55" y="83" width="44" height="107" rx="4" fill="#E74C3C"/> <rect x="129" y="188" width="44" height="2" fill="#dde3ec"/> <rect x="203" y="130" width="44" height="60" rx="4" fill="#E67E22"/> <rect x="278" y="160" width="44" height="30" rx="4" fill="#27AE60"/> <rect x="352" y="103" width="44" height="87" rx="4" fill="#E67E22"/> <rect x="427" y="188" width="44" height="2" fill="#dde3ec"/> <rect x="501" y="143" width="44" height="47" rx="4" fill="#27AE60"/> </g> <g font-size="15" font-weight="700" fill="#1a2433" text-anchor="middle"> <text x="77" y="75">320</text><text x="225" y="122">180</text><text x="300" y="152">90</text><text x="374" y="95">260</text><text x="523" y="135">140</text> </g> <g font-size="14.5" fill="#6b7a8d" text-anchor="middle"> <text x="77" y="212">Lun</text><text x="151" y="212">Mar</text><text x="225" y="212">Mer</text><text x="300" y="212">Jeu</text><text x="374" y="212">Ven</text><text x="449" y="212">Sam</text><text x="523" y="212">Dim</text> </g> <g font-size="14.5" fill="#1a2433"> <rect x="40" y="232" width="14" height="14" rx="3" fill="#27AE60"/><text x="60" y="244">&lt; 150 UA</text> <rect x="170" y="232" width="14" height="14" rx="3" fill="#E67E22"/><text x="190" y="244">150 – 300</text> <rect x="300" y="232" width="14" height="14" rx="3" fill="#E74C3C"/><text x="320" y="244">&gt; 300</text> </g> <text x="40" y="276" font-size="14.5" fill="#6b7a8d">Un profil en dents de scie est normal, et même souhaitable.</text> </svg>' },
  ...
  { id:'acwr', titre:'L\'ACWR : le ratio charge aiguë / chronique',
    ...
    etapes:[
      ...
      { t:'Les zones', x:'Moins de 0,8 : sous-charge (désentraînement possible). De 0,8 à 1,3 : sweet spot ✓ — la zone où viser. De 1,3 à 1,5 : prudence ⚠. Au-delà de 1,5 : zone à risque 🔴 — la charge récente dépasse nettement ce que l\'organisme a l\'habitude d\'encaisser.', svg:'<svg viewBox="0 0 600 256" role="img" aria-label="Jauge de l’ACWR : sous-charge sous 0,8, sweet spot de 0,8 à 1,3, prudence de 1,3 à 1,5, risque au-delà de 1,5 ; le marqueur est à 1,12, dans le sweet spot"> <rect width="600" height="256" fill="#F7F9FC"/> <rect x="8" y="8" width="584" height="240" rx="10" fill="#fff" stroke="#dde3ec"/> <text x="24" y="38" font-size="14" font-weight="700" fill="#6b7a8d" letter-spacing=".06em">ACWR — CHARGE AIGUË / CHRONIQUE</text> <g text-anchor="middle"> <text x="96" y="84" font-size="30" font-weight="800" fill="#15803D">1,12</text> <text x="96" y="106" font-size="14" fill="#6b7a8d">Ratio ACWR</text> <text x="300" y="84" font-size="24" font-weight="800" fill="#1A3A5C">410 UA</text> <text x="300" y="106" font-size="14" fill="#6b7a8d">Charge 7 j (aiguë)</text> <text x="494" y="84" font-size="24" font-weight="800" fill="#1A3A5C">366 UA</text> <text x="494" y="106" font-size="14" fill="#6b7a8d">Chronique / semaine</text> </g> <g> <rect x="24" y="128" width="221" height="24" fill="#E8F8F5"/> <rect x="245" y="128" width="138" height="24" fill="#D4EFDF"/> <rect x="383" y="128" width="83" height="24" fill="#FDEBD0"/> <rect x="466" y="128" width="110" height="24" fill="#FADBD8"/> <rect x="24" y="124" width="221" height="4" fill="#1D4ED8"/> <rect x="245" y="124" width="138" height="4" fill="#15803D"/> <rect x="383" y="124" width="83" height="4" fill="#B45309"/> <rect x="466" y="124" width="110" height="4" fill="#B91C1C"/> <rect x="24" y="124" width="552" height="28" rx="4" fill="none" stroke="#dde3ec"/> </g> <circle cx="333" cy="140" r="12" fill="#15803D" stroke="#fff" stroke-width="3"/> <g font-size="14" font-weight="700" fill="#1a2433" text-anchor="middle"> <text x="134" y="176">Sous-charge</text><text x="314" y="176">✓ Sweet spot</text><text x="424" y="176">⚠ Prudence</text><text x="521" y="176">Risque</text> </g> <g font-size="14" fill="#6b7a8d" text-anchor="middle"> <text x="134" y="196">&lt; 0,8</text><text x="314" y="196">0,8 – 1,3</text><text x="424" y="196">1,3 – 1,5</text><text x="521" y="196">&gt; 1,5</text> </g> <text x="300" y="232" font-size="15" fill="#1a2433" text-anchor="middle">Viser le sweet spot : la charge récente reste proche de l’habitude.</text> </svg>' },
