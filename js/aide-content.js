...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Les répertoires d\'exercices',
    ...
    etapes:[
      ...
      { t:'Composer une séance à partir de plusieurs répertoires', x:'C\'est la conséquence directe : ajoutez un échauffement type, puis un bloc de renforcement, puis un finisher — chacun venant d\'un répertoire différent. Chaque ajout est une copie indépendante, modifier l\'une ne touche pas l\'original.' },
      ...
      { t:'Piocher un seul bloc plutôt que tout le répertoire', x:'Dans le panneau latéral, dépliez un répertoire pour voir ses blocs et ajoutez celui qui vous intéresse. Vous pouvez aussi n\'ajouter qu\'un exercice. Le reste du répertoire n\'est pas touché.' },
      { t:'« Mettre à jour le répertoire »', x:'Ce bouton n\'apparaît que si le répertoire est seul dans la séance — c\'est-à-dire si vous avez vidé avant de l\'ajouter. Dès que vous composez à partir de plusieurs sources, la séance n\'est plus ce répertoire : le bouton propose alors d\'en enregistrer un nouveau, pour ne pas écraser l\'original avec autre chose.' },
      { t:'Étiquetez la pathologie et le sport', x:'Deux champs libres à l\'enregistrement — « LCA », « course à pied ». Ce sont eux qui permettront de retrouver la bonne séance : un nom de répertoire se lit, il ne se filtre pas. Les étiquettes déjà utilisées vous sont proposées, pour éviter que « LCA » et « L.C.A. » coexistent sans le vouloir.' },
      ...
      { t:'Enregistrer la séance en cours comme répertoire', x:'L\'autre chemin, quand une séance composée pour un patient mérite d\'être gardée : le bouton « Sauvegarder » propose de l\'envoyer dans les répertoires plutôt que chez le patient.' },
      { t:'Faire un répertoire d\'une séance déjà enregistrée', x:'Le bouton « Faire un répertoire » sur chaque séance sauvegardée évite de la recharger dans le builder pour l\'enregistrer une seconde fois. C\'est souvent après coup, une fois la séance composée pour un patient, qu\'on se dit qu\'on la refera. La séance en cours dans le builder n\'est pas touchée.' }
    ]},
