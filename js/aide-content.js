...
{ id:'programme', emoji:'📋', titre:'Programme & agenda', articles:[
  ...
  { id:'templates', titre:'Réutiliser une séance : les templates',
    ...
    etapes:[
      ...
      { t:'Ajouter une phase à un protocole', x:'« Nouvelle phase » sous un protocole ouvre le même builder vide, avec le protocole et le numéro de phase déjà remplis. Une phase n\'est rien d\'autre qu\'un template rangé dans un protocole.' },
