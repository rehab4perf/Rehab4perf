...
const CAS = [
  {
    ...
    attendu: [
      ...
      ['Semaine 1 sous la tolérance, mais pas effondrée (24–29 km)',
        (r) => r.semaines[0].volume >= 24 && r.semaines[0].volume <= 29],
      ['Semaine 1 sans aucune intensité',
        (r) => r.semaines[0].intensite === 0],
      ['Le volume toléré (30 km) est atteint dès la semaine 3',
        (r) => r.semaines[2] && r.semaines[2].volume >= 29],
      ['Première séance à allure plus élevée en semaine 2 ou 3',
        (r) => r.premiereQualite !== null && r.premiereQualite <= 3],
      ['Le volume dépasse ensuite la tolérance de départ (2e cycle)',
        (r) => r.volumeMax > 30],
